...
The full DESIGN.md spec lives at [`docs/spec.md`](https://github.com/google-labs-code/design.md/blob/main/docs/spec.md). What follows is a condensed reference.
