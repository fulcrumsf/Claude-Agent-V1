...
|[[Beehiiv]]|[https://www.beehiiv.com/](https://www.beehiiv.com/)|Revenue|beehiiv is a newsletter publishing platform for writing, sending, and growing email newsletters. It includes analytics and monetization options (paid subscriptions, ads) so creators can build an audience and revenue from email.|
|[[Substack]]|[https://substack.com/home](https://substack.com/home)|Revenue|Substack is a publishing platform for newsletters, podcasts, and community posts with built-in paid subscriptions. Use it to publish email content, grow an audience, and monetize directly through subscriptions.|
|[[Daily.ai]]|[https://daily.ai/](https://daily.ai/)|Revenue|[Daily.ai](http://Daily.ai) is an AI-focused newsletter that curates updates on tools, research, and trends. Use it to stay current on what’s shipping in AI and to source ideas for workflows and content.|