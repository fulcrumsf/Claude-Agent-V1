...
Bug reports, feature requests, and PRs are welcome. Read [CONTRIBUTING.md](https://github.com/mvanhorn/cli-printing-press/blob/main/CONTRIBUTING.md) before opening a PR; it explains the PR template, AI / automation disclosure, and the repo boundary between the Printing Press and printed CLIs. [AGENTS.md](https://github.com/mvanhorn/cli-printing-press/blob/main/AGENTS.md) carries the full developer conventions, glossary, commit style, and verification rules.
