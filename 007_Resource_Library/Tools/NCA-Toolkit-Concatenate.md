---
title: "NCA Toolkit Video Concatenation API"
type: api-doc
...
---
tags: [nca-toolkit, video-processing, api, local-infrastructure]
---

# NCA Toolkit

Local API for video processing operations. Built on FFmpeg, runs as a Docker container on this machine.

**Base URL:** `http://localhost:8080`

## What it does
NCA Toolkit exposes REST API endpoints for programmatic video operations — concatenation, compositing, trimming, and more. Used when n8n workflows or Claude Code need to process video files without a cloud service.

## Infrastructure
- Container: `nca-toolkit` (Docker)
- Storage: MinIO S3-compatible (`http://localhost:9000`)
- Always-on: starts with Docker on system boot
