...
Point your assistant at [AGENTS.md](https://github.com/krusemediallc/arcads-claude-code/blob/main/AGENTS.md) and `MASTER_CONTEXT.md` + the skill path. See [AGENTS.md](https://github.com/krusemediallc/arcads-claude-code/blob/main/AGENTS.md) for details.