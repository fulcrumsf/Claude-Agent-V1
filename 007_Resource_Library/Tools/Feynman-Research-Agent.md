...
Need just the skills? [Install the skills-only bundle](https://www.feynman.is/docs/getting-started/installation).

![Feynman CLI](https://www.feynman.is/hero.png)
...
Built on [Pi](https://github.com/badlogic/pi-mono) and [alphaXiv](https://www.alphaxiv.org/). Capabilities ship as Pi skills and every output stays source-grounded.