...
[![timeline_view composite — filmstrip + speaker track + waveform + word labels + silence-gap cut candidates](https://github.com/browser-use/video-use/raw/main/static/timeline-view.svg)](https://github.com/browser-use/video-use/blob/main/static/timeline-view.svg)
...
See [`SKILL.md`](https://github.com/browser-use/video-use/blob/main/SKILL.md) for the full production rules and editing craft.