...
tags:
  - Image-Video-Model
ai_description: >-
  TikTok video by "Cheer |AI Creator" promoting the #LTX-2 open-source model for 20-second cinematic video generation, demonstrating its 'API Playground' with text-to-video features and an example 'cyberpunk girl' prompt, likely saved for content creation tool discovery.
summary: >-
  TikTok video by "Cheer |AI Creator" promoting the #LTX-2 open-source model for 20-second cinematic video generation, demonstrating its 'API Playground' with text-to-video features and an example 'cyberpunk girl' prompt, likely saved for content creation tool discovery.
