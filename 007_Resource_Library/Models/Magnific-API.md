...
](https://docs.magnific.com/quickstart)

## Powerful API tools at your fingertips

## [Image generation API](https://docs.magnific.com/api-reference/mystic/post-mystic)

Create custom visuals from text prompts using our state-of-the-art AI models.

## [Image editing API](https://docs.magnific.com/api-reference/image-upscaler-creative/post-image-upscaler)

Enhance, upscale, relight, and transform images with powerful AI-driven tools.

## [Video generation API](https://docs.magnific.com/api-reference/image-to-video/kling-v2/post-kling-v2)

Convert static images into dynamic videos with customizable motion effects.

## [Icon generation API](https://docs.magnific.com/api-reference/icon-generation/post-generate-icon)

Create stunning icons in different styles from text prompts using our advanced AI models.

## [AI image classifier API](https://docs.magnific.com/api-reference/classifier/post-ai-classifier)

Automatically detect AI-generated content with our advanced classification system.

## [Stock content API](https://docs.magnific.com/api-reference/resources/get-all-resources)
...
Additionally, any page can be accessed as Markdown by appending.md to the URL. For example: [https://docs.magnific.com/introduction](https://docs.magnific.com/introduction) → [https://docs.magnific.com/introduction.md](https://docs.magnific.com/introduction.md)
