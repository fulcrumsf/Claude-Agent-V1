...
# Load environment variables from centralized secrets file in home directory
HOME_SECRETS = Path.home() / ".env-secrets"
load_dotenv(HOME_SECRETS)
ENV_PATH = HOME_SECRETS  # For error messages

# Already have Path imported (checking imports at top)
