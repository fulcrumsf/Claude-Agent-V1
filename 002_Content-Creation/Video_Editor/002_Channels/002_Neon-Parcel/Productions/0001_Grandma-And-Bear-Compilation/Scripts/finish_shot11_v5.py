#!/usr/bin/env python3
"""Upscale and normalize the manually approved Shot 11 v5 raw clip."""
...
TOPAZ = ROOT / "Intermediate/Shot-11-Topaz-2x-v5.mp4"
FINAL = ROOT / "Video_Clips/Shot-11-1080p-v5.mp4"
...
def main() -> None:
    ...
    if TOPAZ.exists() or FINAL.exists():
        raise FileExistsError("Refusing to overwrite existing Shot 11 v5 derivative")
    ...
    subprocess.run([
        ...
        "-c:v", "libx264", "-pix_fmt", "yuv420p", "-c:a", "aac", "-movflags", "+faststart", str(FINAL),
    ], check=True)
