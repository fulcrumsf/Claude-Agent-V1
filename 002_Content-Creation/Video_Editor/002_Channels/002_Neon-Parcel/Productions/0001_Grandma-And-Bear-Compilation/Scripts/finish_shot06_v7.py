#!/usr/bin/env python3
"""Upscale and normalize the manually approved Shot 06 v7 raw clip."""
...
TOPAZ = ROOT / "Intermediate/Shot-06-Topaz-2x-v7.mp4"
FINAL = ROOT / "Video_Clips/Shot-06-1080p-v7.mp4"
...
def update_log(**fields: object) -> None:
    ...
    for item in data.get("assets", []):
        if item.get("shot_id") == "Shot-06" and item.get("version") == "v7-first-last":
            item.update(fields)
