#!/usr/bin/env python3
"""Finish Shot 07 from its existing raw Seedance output; never regenerate it."""
...
RAW = ROOT / "Working/Shot-07-Seedance-2-Mini-480p-v1.mp4"
TOPAZ = ROOT / "Intermediate/Shot-07-Topaz-2x-v1.mp4"
FINAL = ROOT / "Video_Clips/Shot-07-1080p-v1.mp4"
...
def update_log(**fields: object) -> None:
    ...
    for item in data.get("assets", []):
        if item.get("shot_id") == "Shot-07" and item.get("version") == "v1":
            item.update(fields)
