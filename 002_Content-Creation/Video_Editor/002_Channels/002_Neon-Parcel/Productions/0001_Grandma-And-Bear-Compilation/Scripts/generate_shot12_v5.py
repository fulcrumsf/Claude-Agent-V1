#!/usr/bin/env python3
"""Submit an explicitly tagged storyboard-reference test for Shot 12."""
...
PROMPT = ROOT / "Prompts/Shot-12-Seedance-2-Mini-v5.md"
STORYBOARD = ROOT / "Images/Shot-12-Storyboard-v2.png"
RAW = ROOT / "Working/Shot-12-Seedance-2-Mini-480p-v5.mp4"
...
def main() -> None:
    ...
    generate_seedance_mini(
        ...
        version="v5",
        prompt_file=PROMPT,
        retry_reason="tony_revision:controlled @Image1 storyboard-reference test",
        reference_image_urls=[storyboard_url],
    )
    data = json.loads(LOG.read_text(encoding="utf-8"))
    for item in data.get("assets", []):
        if item.get("shot_id") == "Shot-12" and item.get("version") == "v5":
