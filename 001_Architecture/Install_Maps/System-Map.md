...
| App | Version | Path |
|---|---|---|
| 1Password | 8.12.12 | `/Applications/1Password.app` |
| 1Password Browser Helper | 8.12.12 | `/Applications/1Password.app/Contents/Library/LoginItems/1Password Browser Helper.app` |
| 1Password Launcher | 1.0 | `/Applications/1Password.app/Contents/Library/LoginItems/1Password Launcher.app` |
| 1Password Updater | 8.12.12 | `/Applications/1Password.app/Contents/XPCServices/OP Updater Service.xpc/Contents/Helpers/1Password Updater.app` |
| Acrobat | 26.001.21431 | `/Applications/Adobe Acrobat DC/Adobe Acrobat.app` |
| Acrobat | 26.001.21431 | `/Applications/Adobe Acrobat DC/Adobe Acrobat.app/Contents/Helpers/Adobe Acrobat Helper.app` |
...
| Adobe Analysis Server | 26.2.1 | `/Applications/Adobe After Effects 2026/Adobe After Effects 2026.app/Contents/Adobe Analysis Server.app` |
| Adobe Audition 2026 | 26.0.0 | `/Applications/Adobe Audition 2026/Adobe Audition 2026.app` |
...
| Adobe Crash Processor | 29.8.0 | `/Applications/Adobe Illustrator 2026/Adobe Illustrator.app/Contents/Frameworks/AdobeCrashReporter.framework/Versions/A/Adobe Crash Processor.app` |
...
| Adobe Lightroom | 9.3 | `/Applications/Adobe Lightroom CC/Adobe Lightroom.app` |
| Adobe Lightroom Classic | 15.3 | `/Applications/Adobe Lightroom Classic/Adobe Lightroom Classic.app` |
...
| AdobeCrashReport | 26.2.1 | `/Applications/Adobe After Effects 2026/Adobe After Effects 2026.app/Contents/AdobeCrashReport.app` |
| AdobeCrashReport | 26.0.0 | `/Applications/Adobe Audition 2026/Adobe Audition 2026.app/Contents/AdobeCrashReport.app` |
| AdobeCrashReport | 26.3.0 | `/Applications/Adobe Media Encoder (Beta)/Adobe Media Encoder (Beta).app/Contents/AdobeCrashReport.app` |
| AdobeCrashReport | 26.2.0 | `/Applications/Adobe Media Encoder 2026/Adobe Media Encoder 2026.app/Contents/AdobeCrashReport.app` |
| AdobeCrashReport | 22.4.0 | `/Applications/Adobe Photoshop 2026/Adobe Photoshop 2026.app/Contents/AdobeCrashReport.app` |
| AdobeCrashReport | 26.3.0 | `/Applications/Adobe Premiere Pro (Beta)/Adobe Premiere Pro (Beta).app/Contents/AdobeCrashReport.app` |
| AdobeCrashReport | 26.2.0 | `/Applications/Adobe Premiere Pro 2026/Adobe Premiere Pro 2026.app/Contents/AdobeCrashReport.app` |
...
| AdobeCrashReporter | 29.8.0 | `/Applications/Adobe Illustrator 2026/Adobe Illustrator.app/Contents/Frameworks/AdobeCrashReporter.framework/Versions/A/Adobe Crash Reporter.app` |
...
| AdobeResourceSynchronizer | 26.001.21431 | `/Applications/Adobe Acrobat DC/Adobe Acrobat.app/Contents/Helpers/AdobeResourceSynchronizer.app` |
...
| After Effects | 26.2.1 | `/Applications/Adobe After Effects 2026/Adobe After Effects 2026.app` |
| After Effects Render Engine | 26.2.1 | `/Applications/Adobe After Effects 2026/Adobe After Effects Render Engine 2026.app` |
| AIMonitor | AIMonitor version 30.3.0 | `/Applications/Adobe Illustrator 2026/Adobe Illustrator.app/Contents/MacOS/AIMonitor.app` |
| airhost | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/airhost.app` |
| AIRobin | 30.3.0 | `/Applications/Adobe Illustrator 2026/Adobe Illustrator.app/Contents/MacOS/AIRobin.app` |
| AISafeModeLauncher | AISafeModeLauncher version 30.3.0 | `/Applications/Adobe Illustrator 2026/Adobe Illustrator.app/Contents/MacOS/AISafeModeLauncher.app` |
| AISniffer | AISniffer version 30.3.0 | `/Applications/Adobe Illustrator 2026/Adobe Illustrator.app/Contents/MacOS/AISniffer.app` |
| ame_webservice_console | 26.3.0 | `/Applications/Adobe Media Encoder (Beta)/Adobe Media Encoder (Beta).app/Contents/ame_webservice_console.app` |
| ame_webservice_console | 26.2.0 | `/Applications/Adobe Media Encoder 2026/Adobe Media Encoder 2026.app/Contents/ame_webservice_console.app` |
| Antigravity | 1.23.2 | `/Applications/Antigravity.app` |
| Antigravity Helper | — | `/Applications/Antigravity.app/Contents/Frameworks/Antigravity Helper.app` |
| Antigravity Helper (GPU) | — | `/Applications/Antigravity.app/Contents/Frameworks/Antigravity Helper (GPU).app` |
| Antigravity Helper (Plugin) | — | `/Applications/Antigravity.app/Contents/Frameworks/Antigravity Helper (Plugin).app` |
| Antigravity Helper (Renderer) | — | `/Applications/Antigravity.app/Contents/Frameworks/Antigravity Helper (Renderer).app` |
| aomhost | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/aomhost.app` |
...
| Atlas | 147.0.7727.24 | `/Applications/ChatGPT Atlas.app/Contents/Support/ChatGPT Atlas.app` |
| Atlas | 147.0.7727.24 | `/Applications/ChatGPT Atlas.app/Contents/Support/ChatGPT Atlas.app/Contents/Frameworks/ChatGPT Atlas Framework.framework/Versions/147.0.7727.24/Helpers/ChatGPT Atlas (Alerts).app` |
| Atlas | 147.0.7727.24 | `/Applications/ChatGPT Atlas.app/Contents/Support/ChatGPT Atlas.app/Contents/Frameworks/ChatGPT Atlas Framework.framework/Versions/147.0.7727.24/Helpers/ChatGPT Atlas (GPU).app` |
| Atlas | 147.0.7727.24 | `/Applications/ChatGPT Atlas.app/Contents/Support/ChatGPT Atlas.app/Contents/Frameworks/ChatGPT Atlas Framework.framework/Versions/147.0.7727.24/Helpers/ChatGPT Atlas (Plugin).app` |
| Atlas | 147.0.7727.24 | `/Applications/ChatGPT Atlas.app/Contents/Support/ChatGPT Atlas.app/Contents/Frameworks/ChatGPT Atlas Framework.framework/Versions/147.0.7727.24/Helpers/ChatGPT Atlas (Renderer).app` |
| Atlas | 147.0.7727.24 | `/Applications/ChatGPT Atlas.app/Contents/Support/ChatGPT Atlas.app/Contents/Frameworks/ChatGPT Atlas Framework.framework/Versions/147.0.7727.24/Helpers/ChatGPT Atlas (Service).app` |
...
| BlockBlock Helper | 2.4.2 | `/Applications/BlockBlock Helper.app` |
| BlockBlock Helper | 2.2.2 | `/Applications/Object See/BlockBlock Installer.app/Contents/Resources/BlockBlock Helper.app` |
| BlockBlock Installer | 2.4.2 | `/Applications/BlockBlock Helper.app/Contents/Resources/BlockBlock Installer.app` |
...
| caphost | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/caphost.app` |
| CCXProcess | 7.5.0-8 | `/Applications/Utilities/Adobe Creative Cloud Experience/CCXProcess/CCXProcess.app` |
...
| Comet Helper (GPU) | 145.2.7632.4587 | `/Applications/Comet.app/Contents/Frameworks/Comet Framework.framework/Versions/145.2.7632.4587/Helpers/Comet Helper (GPU).app` |
| Comet Helper (GPU) | 145.2.7632.5934 | `/Applications/Comet.app/Contents/Frameworks/Comet Framework.framework/Versions/145.2.7632.5934/Helpers/Comet Helper (GPU).app` |
| Comet Helper (Plugin) | 145.2.7632.4587 | `/Applications/Comet.app/Contents/Frameworks/Comet Framework.framework/Versions/145.2.7632.4587/Helpers/Comet Helper (Plugin).app` |
| Comet Helper (Plugin) | 145.2.7632.5934 | `/Applications/Comet.app/Contents/Frameworks/Comet Framework.framework/Versions/145.2.7632.5934/Helpers/Comet Helper (Plugin).app` |
| Comet Helper (Renderer) | 145.2.7632.4587 | `/Applications/Comet.app/Contents/Frameworks/Comet Framework.framework/Versions/145.2.7632.4587/Helpers/Comet Helper (Renderer).app` |
| Comet Helper (Renderer) | 145.2.7632.5934 | `/Applications/Comet.app/Contents/Frameworks/Comet Framework.framework/Versions/145.2.7632.5934/Helpers/Comet Helper (Renderer).app` |
| CometSoftwareUpdateAgent | — | `/Applications/Comet.app/Contents/Frameworks/Comet Framework.framework/Versions/145.2.7632.4587/Helpers/CometUpdater.app/Contents/Helpers/CometSoftwareUpdate.bundle/Contents/Resources/CometSoftwareUpdateAgent.app` |
...
| CptHost | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/CptHost.app` |
| Creative Cloud | 6.9.0.620 | `/Applications/Utilities/Adobe Creative Cloud/ACC/Creative Cloud.app` |
| Creative Cloud Desktop App | 6.9.0.618 | `/Applications/Utilities/Adobe Creative Cloud/Utils/Creative Cloud Desktop App.app` |
| Creative Cloud Helper | 6.9.0.620 | `/Applications/Utilities/Adobe Creative Cloud/ACC/Creative Cloud Helper.app` |
| Creative Cloud Installer | 6.9.0.618 | `/Applications/Utilities/Adobe Creative Cloud/Utils/Creative Cloud Installer.app` |
| Creative Cloud UI Helper | 6.9.0.620 | `/Applications/Utilities/Adobe Creative Cloud/ACC/Creative Cloud.app/Contents/Frameworks/Creative Cloud UI Helper.app` |
| Creative Cloud UI Helper (GPU) | 6.9.0.620 | `/Applications/Utilities/Adobe Creative Cloud/ACC/Creative Cloud.app/Contents/Frameworks/Creative Cloud UI Helper (GPU).app` |
| Creative Cloud UI Helper (Renderer) | 6.9.0.620 | `/Applications/Utilities/Adobe Creative Cloud/ACC/Creative Cloud.app/Contents/Frameworks/Creative Cloud UI Helper (Renderer).app` |
| Creative Cloud Uninstaller | 6.9.0.618 | `/Applications/Utilities/Adobe Creative Cloud/Utils/Creative Cloud Uninstaller.app` |
...
| Discord | 0.0.381 | `/Applications/Discord.app` |
...
| Distiller | 26.001.21431 | `/Applications/Adobe Acrobat DC/Acrobat Distiller.app` |
...
| Exodus | 26.3.11 | `/Applications/Exodus.app` |
| Exodus | 26.3.11 | `/Applications/Exodus.app/Contents/Frameworks/Exodus Helper.app` |
| Exodus Helper (GPU) | 26.3.11 | `/Applications/Exodus.app/Contents/Frameworks/Exodus Helper (GPU).app` |
| Exodus Helper (Plugin) | 26.3.11 | `/Applications/Exodus.app/Contents/Frameworks/Exodus Helper (Plugin).app` |
| Exodus Helper (Renderer) | 26.3.11 | `/Applications/Exodus.app/Contents/Frameworks/Exodus Helper (Renderer).app` |
...
| Hubstaff | 1.9.1-77a376c9 | `/Applications/Hubstaff.app` |
| IDLE | 3.13.2 | `/Applications/Python 3.13/IDLE.app` |
| Illustrator | 30.3.0 | `/Applications/Adobe Illustrator 2026/Adobe Illustrator.app` |
| IllustratorDiagnosys | 30.3.0 | `/Applications/Adobe Illustrator 2026/Adobe Illustrator.app/Contents/MacOS/IllustratorDiagnosys.app` |
...
| InDesign | 21.3.0.60 | `/Applications/Adobe InDesign 2026/Adobe InDesign 2026.app` |
| InDesignHelper | 21.3.0.60 | `/Applications/Adobe InDesign 2026/Adobe InDesign 2026.app/Contents/MacOS/Helpers/InDesignHelper.app` |
...
| krisp | 3.11.4 | `/Users/tonymacbook2025/Applications/krisp.app/Contents/Frameworks/krisp Helper.app` |
| krisp Helper (GPU) | 3.11.4 | `/Users/tonymacbook2025/Applications/krisp.app/Contents/Frameworks/krisp Helper (GPU).app` |
| krisp Helper (Plugin) | 3.11.4 | `/Users/tonymacbook2025/Applications/krisp.app/Contents/Frameworks/krisp Helper (Plugin).app` |
| krisp Helper (Renderer) | 3.11.4 | `/Users/tonymacbook2025/Applications/krisp.app/Contents/Frameworks/krisp Helper (Renderer).app` |
...
| LogTransport | 29.8.0 | `/Applications/Adobe Illustrator 2026/Adobe Illustrator.app/Contents/Frameworks/AdobeCrashReporter.framework/Versions/A/LogTransport.app` |
...
| LogTransport2 | — | `/Applications/Adobe InDesign 2026/Adobe InDesign 2026.app/Contents/MacOS/Helpers/InDesignHelper.app/Contents/MacOS/LogTransport2.app` |
| LogTransport2 | — | `/Applications/Adobe InDesign 2026/Adobe InDesign 2026.app/Contents/MacOS/LogTransport2.app` |
...
| Media Encoder | 26.2.0 | `/Applications/Adobe Media Encoder 2026/Adobe Media Encoder 2026.app` |
| Media Encoder (Beta) | 26.3.0 | `/Applications/Adobe Media Encoder (Beta)/Adobe Media Encoder (Beta).app` |
...
| Premiere | 26.2.0 | `/Applications/Adobe Premiere Pro 2026/Adobe Premiere Pro 2026.app` |
| Premiere (Beta) | 26.3.0 | `/Applications/Adobe Premiere Pro (Beta)/Adobe Premiere Pro (Beta).app` |
...
| Raycast | 1.104.10 | `/Applications/Raycast.app` |
...
| Save as Adobe PDF | 26.001.21431 | `/Applications/Adobe Acrobat DC/Acrobat Distiller.app/Contents/Resources/SelfHealFiles/Library/PDF_Services/Save as Adobe PDF.app` |
...
| Slack Helper (GPU) | 4.46.101 | `/Applications/Slack.app/Contents/Frameworks/Slack Helper (GPU).app` |
| Slack Helper (Plugin) | 4.46.101 | `/Applications/Slack.app/Contents/Frameworks/Slack Helper (Plugin).app` |
| Slack Helper (Renderer) | 4.46.101 | `/Applications/Slack.app/Contents/Frameworks/Slack Helper (Renderer).app` |
...
| TeamProjectsLocalHub | 26.2.1 | `/Applications/Adobe After Effects 2026/Adobe After Effects 2026.app/Contents/TeamProjectsLocalHub.app` |
| TeamProjectsLocalHub | 26.3.0 | `/Applications/Adobe Media Encoder (Beta)/Adobe Media Encoder (Beta).app/Contents/TeamProjectsLocalHub.app` |
| TeamProjectsLocalHub | 26.2.0 | `/Applications/Adobe Media Encoder 2026/Adobe Media Encoder 2026.app/Contents/TeamProjectsLocalHub.app` |
...
| Transcode | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/Transcode.app` |
...
| uninstall | 2026.1.0 | `/Applications/Maxon Cinema 4D 2026/uninstall.app` |
| Uninstall Resolve | — | `/Applications/DaVinci Resolve/Uninstall Resolve.app` |
| Uninstaller | 1.2.13 | `/Users/tonymacbook2025/Applications/Utilities/krisp/Uninstaller.app` |
| Untitled | — | `/Applications/Adobe Acrobat DC/Adobe Acrobat.app/Contents/Plugins/Preflight.acroplugin/Contents/Helpers/Droplet.app` |
...
| ZMScreenshot | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/ZMScreenshot.app` |
| zoom.us | 6.7.7 (76486) | `/Applications/zoom.us.app` |
| ZoomAutoUpdater | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/ZoomAutoUpdater.app` |
| ZoomClips | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/ZoomClips.app` |
| ZoomHybridConf | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/ZoomHybridConf.app` |
| ZoomPhone | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/ZoomPhone.app` |
| ZoomUninstaller | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Frameworks/ZoomUninstaller.app` |
| ZoomUpdater | 6.7.7 (76486) | `/Applications/zoom.us.app/Contents/Library/LaunchAgents/ZoomUpdater.app` |
...
| brotli | 1.1.0 |
| c-ares | 1.34.5 |
| ca-certificates | 2025-02-25, 2026-03-19 |
| cairo | 1.18.4 |
| certifi | 2026.2.25 |
| cjson | 1.7.18 |
...
| ollama | 0.6.7 |
| onnx | 1.21.0 |
| openai-whisper | 20250625_4 |
| openblas | 0.3.32 |
| opencore-amr | 0.1.6 |
| openexr | 3.4.0_2 |
| openjpeg | 2.5.3 |
| openjph | 0.24.1 |
| openssl@3 | 3.4.1, 3.6.1 |
| opus | 1.5.2, 1.6.1 |
| p11-kit | 0.25.5 |
| pango | 1.56.3 |
| pcre2 | 10.46 |
...
|---|---|---|---|
| n8n-custom | 2.12.3 | 1.19GB | 03ba224d37e6 |
| n8n-custom | 2.11.2 | 1.16GB | 92876d2ec29f |
| cloudflare/cloudflared | latest | 72.2MB | 4f190dd4452d |
| n8n-custom | 2.1.4 | 1.06GB | dedd010688f3 |
| nca-toolkit-arm | latest | 3.19GB | 7ed14f681b97 |
| docker.n8n.io/n8nio/n8n | latest | 991MB | 9bf976cfcfa9 |
| docker_config-character-generator-app | latest | 50MB | 97d363d1b285 |
| docker_config-puppeteer | latest | 1.47GB | d1abf7bfa92d |
| comfyui-cpu | latest | 2.65GB | a37220fc53e6 |
| docker_config-mmaudio | latest | 2.17GB | 36d0706ac35e |
| docker_config-saliency-api | latest | 780MB | ee4766d53e5b |
| stephengpope/no-code-architects-toolkit | latest | 10.3GB | 44921848a32b |
| baserow/baserow | latest | 2.25GB | 272b1905470a |
| curlimages/curl | latest | 31.6MB | bf9e201037a0 |
| python | 3.10-slim | 153MB | 69d9a9ad218b |
| postgres | 16-alpine | 267MB | 601184fa4506 |
| flowiseai/flowise | latest | 2.61GB | 641c8a667553 |
| quay.io/minio/minio | latest | 175MB | 6c83c74c8028 |
| qdrant/qdrant | latest | 205MB | 4f6be05216e9 |
| ghcr.io/open-webui/open-webui | main | 4.11GB | 66da16bc788f |
| ghcr.io/remsky/kokoro-fastapi-cpu | v0.2.2 | 3.39GB | 06999f963e3b |

### Volumes

- `docker_config_baserow_data`
- `docker_config_baserow_media`
- `docker_config_baserow_static`

### Networks

- `bridge` (driver: bridge)
- `docker_config_unomas` (driver: bridge)
- `host` (driver: host)
- `none` (driver: null)
- `unomas` (driver: bridge)
...
| CLI | Version | Path |
|---|---|---|
| `gh` | gh version 2.88.1 (2026-03-12) | `/opt/homebrew/bin/gh` |
...
| `vercel` | 50.34.3 | `/opt/homebrew/bin/vercel` |
