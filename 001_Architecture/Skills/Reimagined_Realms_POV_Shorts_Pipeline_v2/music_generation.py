...
def submit_music_task(prompt: str, instrumental: bool = True, model: str = "V4_5") -> str:
    """Confirmed live 2026-08-08: this always calls Suno with --customMode false (below), and in
    non-custom mode kie-cli caps --prompt at 500 characters (vs. up to 5000 in custom mode) — an
    over-length prompt fails the API call outright. Keep the mood/instrumentation description
    concise; there's no separate style/title field to offload detail onto in this mode.
    """
